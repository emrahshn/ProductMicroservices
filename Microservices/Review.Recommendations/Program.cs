...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Review.Recommendations", Version = "v1" });
});
...
app.UseSwagger();
app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Review.Recommendations v1"));
